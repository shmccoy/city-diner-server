  ...
  return [
    {
      ...
      description:
        "Two eggs, served with your choice of bacon, bologna, link or patty sausage, choice of home fries, fried apples or grits and your choice of toast, biscuit or short stack.",
      price: "7.25",
      category: "Breakfast",
    },
    {
      ...
      name: "Western Omelet",
      description:
        "Ham, tomatoes, onions, peppers, mushrooms and American cheese.",
      price: "7.95",
      category: "Omelets",
    },
    {
      ...
      name: "Irish Benedict",
      description:
        "Two poached eggs served over grilled corned beef on a toasted English muffin. Served with fries, fried apples or grits.",
      price: "8.50",
      category: "Benedicts",
    },
    {
      ...
      description:
        "With your choice of bacon, City ham, link or sausage patty.",
      price: "6.50",
      category: "Pancakes",
    },
  ];
...
function seedUsers(db, auth_user) {
  ...
  return db
    ...
    .insert(preppedUsers)
    .then(() =>
      db.raw(`SELECT setval('auth_user_id_seq', ?)`, [
...
function seedMenuTable(db, menu) {
  return db.transaction(async (trx) => {
    ...
    await trx.raw(`SELECT setval('menu_id_seq', ?)`, [
